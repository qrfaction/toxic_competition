...
from keras.layers import Conv1D,Multiply,Permute,MaxPool1D,SpatialDropout1D,concatenate,Activation,BatchNormalization
...
class model:
    ...
    def CNNmodel(self):
        ...
        conv4 = GlobalAveragePooling1D()(conv4)
        ...
        conv5 = GlobalAveragePooling1D()(conv5)
